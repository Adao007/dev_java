...
public class CircularQueue<E> implements QueueInterface<E>{
	...
	// ENQUEUE method START: adds an element into the Queue 
	@Override
	...
	//DEQUEUE method START: removes an element from the Queue 
	@Override
	public E dequeue() {
